          ...
          NextLetterWrapper wrapper = new NextLetterWrapper();
            switch (letter)
            {
                ...
                case (char)alphabet.Letter_X:
                    ...
                    wrapper.voicePath = Properties.Resources.audio_Zaglavnaya_Ha2_wav;
                    return wrapper;
                case (char)alphabet.Letter_x:
                    wrapper.letterDescription = "'х'  Правая - 4-м направо вверх";
                    wrapper.directionDescription = "LeftSpace";
                    wrapper.voicePath = Properties.Resources.audio_Bukva_ha2_wav;
                    return wrapper;
                case (char)alphabet.Letter_ZE:
                    wrapper.letterDescription = "'Ц'  Шифт + Левая - 3-м вверх";
                    wrapper.directionDescription = "RightHand";
                    wrapper.voicePath = Properties.Resources.audio_Zaglavnaya_Ce2_wav;
                    return wrapper;
                case (char)alphabet.Letter_ze:
                    wrapper.letterDescription = "'ц'  Левая - 3-м вверх";
                    wrapper.directionDescription = "RightHand";
                    wrapper.voicePath = Properties.Resources.audio_Bukva_ce2_wav;
                    return wrapper;
                case (char)alphabet.Letter_CH:
                    wrapper.letterDescription = "'Ч'  Шифт + Левая - 3-м вниз";
                    wrapper.directionDescription = "RightHand";
                    wrapper.voicePath = Properties.Resources.audio_Zaglavnaya_CHe2_wav;
                    return wrapper;
                case (char)alphabet.Letter_ch:
                    wrapper.letterDescription = "'ч'  Левая - 3-м вниз";
                    wrapper.directionDescription = "RightHand";
                    wrapper.voicePath = Properties.Resources.audio_Bukva_che2_wav;
                    return wrapper;
                case (char)alphabet.Letter_Sh:
                    wrapper.letterDescription = "'Ш'  Шифт + Правая - 2-м вверх";
                    wrapper.directionDescription = "LeftHand";
                    wrapper.voicePath = Properties.Resources.audio_Zaglavnaya_Sha2_wav;
                    return wrapper;
                case (char)alphabet.Letter_sh:
                    wrapper.letterDescription = "'ш'  Правая - 2-м вверх";
                    wrapper.directionDescription = "LeftHand";
                    wrapper.voicePath = Properties.Resources.audio_Bukva_sha2_wav;
                    return wrapper;
                case (char)alphabet.Letter_SCHe:
                    wrapper.letterDescription = "'Щ'  Шифт + Правая - 3-м вверх";
                    wrapper.directionDescription = "LeftHand";
                    wrapper.voicePath = Properties.Resources.audio_Zaglavnaya_Shcha2_wav;
                    return wrapper;
                case (char)alphabet.Letter_sche:
                    wrapper.letterDescription = "'щ'  Правая - 3-м вверх";
                    wrapper.directionDescription = "LeftHand";
                    wrapper.voicePath = Properties.Resources.audio_Bukva_shcha2_wav;
                    return wrapper;
                case (char)alphabet.Letter_HARD:
                    wrapper.letterDescription = "'ъ'  Правая - 4-м направо в угол";
                    wrapper.directionDescription = "LeftHand";
                    wrapper.voicePath = Properties.Resources.audio_Zaglavnaya_Tvyordyj_znak2_wav;
                    return wrapper;
                case (char)alphabet.Letter_bl:
                    wrapper.letterDescription = "'ы'  Левая - 3-м на месте";
                    wrapper.directionDescription = "LeftHand";
                    wrapper.voicePath = Properties.Resources.audio_Bukva_y2_wav;
                    return wrapper;
                case (char)alphabet.Letter_Soft:
                    wrapper.letterDescription = "'ь'  Правая - 1-м вниз";
                    wrapper.directionDescription = "LeftHand";
                    wrapper.voicePath = Properties.Resources.audio_Bukva_myagkij_znak2_wav;
                    return wrapper;
                case (char)alphabet.Letter_EE:
                    wrapper.letterDescription = "'Э'  Шифт + Правая - 4-м направо на месте";
                    wrapper.directionDescription = "LeftHand";
                    wrapper.voicePath = Properties.Resources.audio_Zaglavnaya_Ye2_wav;
                    return wrapper;
                case (char)alphabet.Letter_ee:
